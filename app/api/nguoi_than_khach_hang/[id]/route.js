...
export async function PATCH(request, { params }) {
  try {
    ...
    */
    ...
    const { error } = await supabase.from('nguoi_than_khach_hang').update(dataToUpdate).eq('id', id)
...
export async function DELETE(request, { params }) {
  try {
    ...
    const { error } = await supabase.from('nguoi_than_khach_hang').delete().eq('id', idToDelete) //
